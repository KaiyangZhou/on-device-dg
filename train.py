...
# Datasets
import datasets.p_air
import datasets.p_cars
import datasets.p_ctech
import datasets.p_pets
...
import trainers.kd.kd
import trainers.kd.fitnet
import trainers.kd.attention
import trainers.kd.similarity
import trainers.kd.vid
import trainers.kd.crd
...
def extend_cfg(cfg):
    ...
    # Dataset
    cfg.DATASET.ENV = "2k"  # {2k, full}

    # Architecture of teacher model in KD methods
